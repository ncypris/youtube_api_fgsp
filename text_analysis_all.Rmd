...
toks_barbie <- toks_barbie %>% 
  ...
  tokens_remove(pattern = c("href", "quot", "amp")) # removing other unnecessary words
```
...
Do the above-mentioned steps for the Oppenheimer movie. Which words are the most prominent words there?
